...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('business', 'vance@ace-success.com.sg');
      //$p->add_field('business', 'ravigohil999@gmail.com');
      ...
      $p->add_field('key', $key);
      $p->add_field('Invoice Number', $id);
      $p->add_field('Company_name', $company_name);
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) { 
         ...
         $to = 'ravigohil999@gmail.com';    //  your email
